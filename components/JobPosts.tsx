    ...
    <section className="max-w-5xl mx-auto grid gap-4 grid-cols-1 mb-20">
      {jobs.map((job, index) => (
        <motion.a
          ...
          className="border border-zinc-600 p-4 hover:border-zinc-500 focus:border-zinc-500 bg-zinc-900 hover:bg-zinc-200/5 focus:bg-zinc-200/5 rounded-xl transition-colors outline-hidden group"
        >
